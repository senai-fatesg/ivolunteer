...
/**
 * 
 * Classe de exemplo de como construir um caso de teste baseado em interface
 * 
 * Teste feito utilizando framework Selenium
 * 
 * Para criar seus proprios teste utilizar Selenium - Web Browser (Firefox)
...
public class LoginTestIT {
  ...
  /**
   * Metodo inicial do Teste para ser executado via JUnit
   * @throws Exception
   */
  @Test
  public void testExemploIVolunteer() throws Exception {
